...
def test_mamba2_modeling(L, B, T, H, D, dtype, use_l2warp):
    run_test_model_forward_backward(L, B, T, H, D, Mamba2Config, dtype, use_l2warp)
...
def test_mamba2_generation(L, B, T, H, D, dtype):
    run_test_generation(L, B, T, H, D, Mamba2Config, dtype)
