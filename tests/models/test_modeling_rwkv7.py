...
def test_rwkv7_modeling(L, B, T, H, D, dtype, use_l2warp):
    run_test_model_forward_backward(L, B, T, H, D, RWKV7Config, dtype, use_l2warp)
...
def test_rwkv7_generation(L, B, T, H, D, dtype):
