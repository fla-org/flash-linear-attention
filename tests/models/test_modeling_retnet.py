...
def test_retnet_modeling(L, B, T, H, D, dtype, use_l2warp):
    run_test_model_forward_backward(L, B, T, H, D, RetNetConfig, dtype, use_l2warp)
...
def test_retnet_generation(L, B, T, H, D, dtype):
