...
def test_hgrn2_modeling(L, B, T, H, D, dtype, use_l2warp):
    run_test_model_forward_backward(L, B, T, H, D, HGRN2Config, dtype, use_l2warp)
...
def test_hgrn2_generation(L, B, T, H, D, dtype):
