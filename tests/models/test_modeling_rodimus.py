...
def test_rodimus_modeling(L, B, T, H, D, dtype, use_l2warp):
    run_test_model_forward_backward(L, B, T, H, D, RodimusConfig, dtype, use_l2warp)
...
def test_rodimus_generation(L, B, T, H, D, dtype):
