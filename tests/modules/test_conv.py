...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(*test, id="B{}_T{}_D{}_W{}_activation{}_has_bias{}_has_residual{}_{}".format(*test))
        for test in [
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *test, id="B{}_T{}_D{}_W{}_activation{}_has_bias{}_has_residual{}_{}_{}".format(*test))
        for test in [
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            *test,
            id="N{}_T{}_D{}_W{}_activation{}_has_bias{}_has_residual{}_{}_{}".format(*test),
        )
        for test in [
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(*test, id="B{}_D{}_W{}_has_bias{}_has_residual{}_activation{}_{}_{}".format(*test))
        for test in [
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(*test, id="B{}_T{}_D{}_W{}_has_bias{}_has_residual{}_activation{}_{}".format(*test))
        for test in [
