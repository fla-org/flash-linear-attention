...
from fla.modules.fused_norm_gate_npu import FusedLayerNormGated, FusedRMSNormGated
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for test in [
            ...
            (1, 32, 32768, 128,  True, "sigmoid", True),
            (1, 32, 32768, 128,  True, "silu", True),
            (1, 32, 32768, 128,  False, "sigmoid", False),
            (1, 32, 1024, 128,  False, "silu", False),
        ]
    ],
)
