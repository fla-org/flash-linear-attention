...
def chunk_dplr_bwd_kernel_intra_tensorcore(
    ...
    # Mask: i > j (Strict Lower Triangular)
    ...
    # dk = dA_qk.T @ Q' + dA_ak.T @ A'
    # db = dA_qb.T @ Q' + dA_ab.T @ A'
    ...
    b_dq = b_dq_intra * exp_gi + b_dqg * exp_gi * scale
    b_da = (b_da_intra + b_dag) * exp_ge

    term_inter = exp_g_last[None, :]
    b_dk = (b_dk_intra + b_dkg * term_inter) * inv_exp_gi
    b_db = (b_db_intra + b_dbg * term_inter) * inv_exp_gi
