...
def chunk_oja2_bwd_dqk(
    ...
    # 计算dA
    grid = (NK, NT, B * H)
    chunk_oja2_bwd_kernel_dqk[grid](
        q,
        k,
        h,
        gv,
...
@triton.jit(do_not_specialize=['T'])
def chunk_oja2_bwd_kernel_dv_o(
    v,
    g,
    o,
    A,
...
def chunk_oja2_bwd_dv_o(
    ...
    chunk_oja2_bwd_kernel_dv_o[grid](
        v=v,
        g=gv,
        o=o,
        A=A,
