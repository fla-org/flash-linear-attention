        ...
        **kwargs,
        ...
        if use_output_correction:
            warnings.warn(
                ...
                "In practice, we recommend trying both settings. ", stacklevel=2,
            )
        ...
        if use_short_conv:
            ...
            warnings.warn(
                ...
                "Do not turn it off, i.e., setting `use_short_conv=False` unless you know what you are doing.", stacklevel=2,
            )
        if use_output_gate:
