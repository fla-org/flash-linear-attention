...
""" Implementing the Optimizing Mixture of Block Attention (flash-moba) module. Reference:
    ...
    def forward(
        ...
        **kwargs,
        ...
        if attention_mask is not None:
            ...
            # Cached decoding can make the KV length differ from the full mask length.
